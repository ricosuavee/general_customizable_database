...
def check_changes(db, table):
 ...
 # Need a function to modify rows individually by their entry code in case of data entry errors.    
    
    
## User interface functions 

# Instead of relying on the user to input a "type" of database, ask the user to either create or open a .db file and table. 
